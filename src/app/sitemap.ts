...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    },
    {
      ...
      {
        url: `${baseUrl}/blog/attendance-software-for-marketing-agencies`,
        lastModified: new Date(),
        changeFrequency: "monthly",
        priority: 0.75,
      },
      ...
      {
        url: `${baseUrl}/blog/attendance-software-for-restaurants`,
        lastModified: new Date(),
        changeFrequency: "monthly",
        priority: 0.75,
      },
      {
        url: `${baseUrl}/blog/attendance-software-for-construction-companies`,
        lastModified: new Date(),
        changeFrequency: "monthly",
        priority: 0.75,
      },
      ...
      {
        url: `${baseUrl}/blog/employee-leave-management-system`,
        lastModified: new Date(),
        changeFrequency: "monthly",
        priority: 0.75,
      },
      {
        url: `${baseUrl}/blog/overtime-management-software`,
        lastModified: new Date(),
        changeFrequency: "monthly",
        priority: 0.75,
      },
