...
export default function LandingPage() {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      image: "https://attendx.info/og-image.png",
      description:
        "AttendX is a smart attendance and payroll management software for Pakistani businesses.",
      offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "PKR",
          ...
          <div className="max-w-7xl mx-auto text-center z-10 w-full mt-10 md:mt-0">
            ...
            <motion.div
              ...
              <motion.p
                ...
                AttendX is a smart attendance and payroll management system for Pakistani businesses. Track employee attendance, manage payroll in PKR, monitor staff activity, and automate workforce operations from one powerful platform.
              </motion.p>
